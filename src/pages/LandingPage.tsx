...
const LandingPage: FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{`${CONSTANTS.APP_NAME} - Discover the Perfect Cocktail for Your Mood`}</title>
        <meta
          name="description"
          content="Discover amazing cocktails based on your mood. Browse recipes, track your bar inventory, and join our community of cocktail enthusiasts."
        />
        <meta
          name="keywords"
          content="cocktails, recipes, drinks, mixology, mood-based, bartending"
        />
      </Helmet>
